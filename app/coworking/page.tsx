...
import { Armchair, Users, MapPin, Clock, Navigation } from "lucide-react"
...
export default function CoworkingPage() {
  const { asientos, ultimaActualizacion } = useCoworking()
        ...
        <section className="relative overflow-hidden pt-24 pb-8">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-4 text-pretty max-w-3xl mx-auto leading-relaxed">
              Consulta en tiempo real la disponibilidad de las áreas de trabajo. Visualiza el estado de cada asiento
            ...
            <div className="mb-6">
              <div className="flex flex-wrap justify-center gap-4 py-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">({contarPorEstado(asientos, "fuera-servicio")})</span>
                </div>
                <div className="flex items-center gap-2">
