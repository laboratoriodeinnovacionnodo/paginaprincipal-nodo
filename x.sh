#!/usr/bin/env bash
# ============================================================================
#  x.sh — ciudadano-front  v2.1.0
#  /laboratorio — página estática (sin API), describe el lab y sus áreas.
# ============================================================================
set -euo pipefail
...
# ─────────────────────────────────────────────────────────────────────────────
echo "📄  Reescribiendo app/laboratorio/page.tsx (estático, sin API)..."
# ─────────────────────────────────────────────────────────────────────────────
...
ok "app/laboratorio/page.tsx → estático, sin API"
...
echo ""
echo "════════════════════════════════════════════════════════════"
echo "✅  /laboratorio — maquetado estático listo"
echo ""
echo "    Sin API, sin fetch, sin riesgo de error en producción."
echo "    Cuando quieras conectar proyectos reales, avisá."
echo "════════════════════════════════════════════════════════════"