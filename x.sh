#!/usr/bin/env bash
# ============================================================
# add-noticia-modal.sh — v1.0.0
# Reemplaza la navegación a /noticias/[slug] por un Dialog
# que muestra el contenido completo de la noticia inline.
# La URL se actualiza con router.push para compartibilidad.
# Solo toca: components/noticias/noticias-content.tsx
# ============================================================
set -euo pipefail
...
warn "Reescribiendo components/noticias/noticias-content.tsx con modal..."
...
log "noticias-content.tsx reescrito con modal ✓"

echo ""
echo -e "${BOLD}${GREEN}================================================${RESET}"
echo -e "${BOLD}${GREEN}  Modal de noticia agregado correctamente ✅    ${RESET}"
echo -e "${BOLD}${GREEN}================================================${RESET}"
echo ""
echo "  Comportamiento:"
echo "  • Click en la card → abre Dialog con la noticia completa"
echo "  • URL se actualiza a /noticias/[slug] (compartible)"
echo "  • Cerrar modal → URL vuelve a /noticias"
echo "  • Click en tags dentro del modal → cierra y filtra"
echo "  • Click en categoría de la card → filtra (no abre modal)"
echo "  • 'Abrir en página completa ↗' → tab nuevo para la URL estática"
echo "  • Cards con hover -translate-y-0.5 + scale imagen"
echo "  • Solo se toca noticias-content.tsx"
echo ""