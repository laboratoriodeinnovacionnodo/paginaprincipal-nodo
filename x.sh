#!/usr/bin/env bash
# ============================================================================
#  v32-ciudadano-ocultar-auth-navbar.sh  — ciudadano-front
#  Oculta el botón login/avatar del header tanto en desktop como en mobile.
#  Solo toca components/header.tsx
# ============================================================================
set -euo pipefail
...
echo ""
echo "════════════════════════════════════════════════════════════"
echo "  v32 · ciudadano-front · ocultar auth del navbar"
echo "════════════════════════════════════════════════════════════"
echo ""

echo "📄  components/header.tsx"
cat > components/header.tsx << 'TSEOF'
"use client"
...
echo -e "\033[0;32m════════════════════════════════════════════════════════════\033[0m"
echo ""
echo "  Cambios en components/header.tsx:"
echo "    ✗  <HeaderAuth /> eliminado del desktop"
echo "    ✗  <HeaderAuthMobileCard /> eliminado del drawer mobile"
echo "    ✗  imports de HeaderAuth, HeaderAuthMobileCard, GraduationCap eliminados"
echo ""